...
从视频或图片文件夹制作四宫格封面和详情展示图的本地工作台。当前源码版本：**0.3.2**。
...
[下载 Windows 0.3.1 x64 安装包](https://github.com/HUAIDAO1104/Vdeo-frame-pro/releases/download/desktop-v0.3.1/SalesKitStudio_0.3.1_x64-setup.exe)（约 60 MB）。[发行说明](https://github.com/HUAIDAO1104/Vdeo-frame-pro/releases/tag/desktop-v0.3.1)、[构建与发布验证](docs/releases/0.3.1-verification.md)。已安装 0.2.0 及更新版本可在应用内更新；0.1.6 及更早版本没有更新模块，需要先关闭旧程序、运行一次新版安装包，无需预先卸载。
